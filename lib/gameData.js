...
// Position-first, rating-ranked order: all GKs (highest OVR first), then
// Defenders, then Midfielders, then Forwards.
function buildOrder(){
...
module.exports = { PLAYERS, BASE_PRICE, CAT_LABEL, FORMATIONS, BUDGET, catOf, buildOrder, nextIncrement };
